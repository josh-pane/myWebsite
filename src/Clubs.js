...
class Experience extends Component {
  render() {
    return (
      ...
      A few examples of these services are smb, apache, DNS, FTP, ssh, databases, etc. Some of the distributions include FreeBSD, Centos, Ubuntu, ArchLinux, Fedora, etc.</p>
      ...
      I am the event coordinator for WICS at Baylor.</p>

      <h3> <font size="5"> ICPC</font></h3>
      <p> In 2018 I was part of Baylor's top performing ICPC (International Collegiate Programming Contest) team. We got 10th out of over 80 teams.</p>
      </div>
